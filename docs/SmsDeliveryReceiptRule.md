...
**match_type** | **number** | The type of match. | [optional] [default to undefined]
**action** | **string** | The type of action. | [optional] [default to undefined]
...
```typescript
import { SmsDeliveryReceiptRule } from 'clicksend';

const instance: SmsDeliveryReceiptRule = {
    receipt_rule_id,
    rule_name,
    match_type,
    action,
