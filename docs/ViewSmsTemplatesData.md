...
**data** | [**Array&lt;SmsTemplate&gt;**](SmsTemplate.md) | The parameters related to the actual templates. | [optional] [default to undefined]

## Example

```typescript
import { ViewSmsTemplatesData } from 'clicksend';

const instance: ViewSmsTemplatesData = {
    total,
    per_page,
    current_page,
    last_page,
