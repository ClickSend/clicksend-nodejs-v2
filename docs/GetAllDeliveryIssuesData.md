...
**data** | [**Array&lt;DeliveryIssue&gt;**](DeliveryIssue.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetAllDeliveryIssuesData } from 'clicksend';

const instance: GetAllDeliveryIssuesData = {
    total,
    per_page,
    current_page,
    last_page,
