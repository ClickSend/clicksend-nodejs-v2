...
**data** | [**Array&lt;SmsReceipt&gt;**](SmsReceipt.md) | The parameters related to the actual message receipts. | [optional] [default to undefined]

## Example

```typescript
import { ViewSmsReceiptsData } from 'clicksend';

const instance: ViewSmsReceiptsData = {
    total,
    per_page,
    current_page,
    last_page,
