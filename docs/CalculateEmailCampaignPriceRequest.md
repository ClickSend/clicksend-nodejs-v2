...
**from_email_address_id** | **string** |  | [optional] [default to undefined]
...
```typescript
import { CalculateEmailCampaignPriceRequest } from 'clicksend';

const instance: CalculateEmailCampaignPriceRequest = {
    name,
    subject,
