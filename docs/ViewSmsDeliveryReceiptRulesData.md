...
**data** | [**Array&lt;SmsDeliveryReceiptRule&gt;**](SmsDeliveryReceiptRule.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewSmsDeliveryReceiptRulesData } from 'clicksend';

const instance: ViewSmsDeliveryReceiptRulesData = {
    total,
    per_page,
    current_page,
    last_page,
