...
**data** | [**Array&lt;VoiceDeliveryReceiptRule&gt;**](VoiceDeliveryReceiptRule.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewVoiceDeliveryReceiptRulesData } from 'clicksend';

const instance: ViewVoiceDeliveryReceiptRulesData = {
    total,
    per_page,
    current_page,
    last_page,
