...
**data** | [**Array&lt;ViewStrippedStringRulesDataAllOfDataInner&gt;**](ViewStrippedStringRulesDataAllOfDataInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewStrippedStringRulesData } from 'clicksend';

const instance: ViewStrippedStringRulesData = {
    total,
    per_page,
    current_page,
    last_page,
