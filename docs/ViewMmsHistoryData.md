...
**data** | [**Array&lt;ViewMmsHistoryDataAllOfDataInner&gt;**](ViewMmsHistoryDataAllOfDataInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewMmsHistoryData } from 'clicksend';

const instance: ViewMmsHistoryData = {
    total,
    per_page,
    current_page,
    last_page,
