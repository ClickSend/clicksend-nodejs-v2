...
**data** | [**Array&lt;EmailAddress&gt;**](EmailAddress.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewAllowedEmailAddressesData } from 'clicksend';

const instance: ViewAllowedEmailAddressesData = {
    total,
    per_page,
    current_page,
    last_page,
