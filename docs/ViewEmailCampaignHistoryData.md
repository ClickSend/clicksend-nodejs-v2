...
**data** | [**Array&lt;EmailCampaignHistory&gt;**](EmailCampaignHistory.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewEmailCampaignHistoryData } from 'clicksend';

const instance: ViewEmailCampaignHistoryData = {
    total,
    per_page,
    current_page,
    last_page,
