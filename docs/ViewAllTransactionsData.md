...
**data** | [**Array&lt;ViewAllTransactionsDataAllOfDataInner&gt;**](ViewAllTransactionsDataAllOfDataInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewAllTransactionsData } from 'clicksend';

const instance: ViewAllTransactionsData = {
    total,
    per_page,
    current_page,
    last_page,
