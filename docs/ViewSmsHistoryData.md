...
**data** | [**Array&lt;ViewSmsHistoryDataAllOfDataInner&gt;**](ViewSmsHistoryDataAllOfDataInner.md) | The parameters related to the actual SMS. | [optional] [default to undefined]

## Example

```typescript
import { ViewSmsHistoryData } from 'clicksend';

const instance: ViewSmsHistoryData = {
    total,
    per_page,
    current_page,
    last_page,
