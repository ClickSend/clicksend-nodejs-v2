...
**data** | [**Array&lt;ViewAvailableNumbersDataAllOfDataInner&gt;**](ViewAvailableNumbersDataAllOfDataInner.md) |  | [optional] [default to undefined]
**_currency** | [**Currency**](Currency.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewAvailableNumbersData } from 'clicksend';

const instance: ViewAvailableNumbersData = {
    total,
    per_page,
    current_page,
    last_page,
