...
**show_summary** | **boolean** | Used for showing additional information in the response. You can either specify:   - **True:** It will show the additional information.        - **False:** It will only show the basic information. This is the default value.               | [optional] [default to undefined]

## Example

```typescript
import { CalculateSmsPriceRequestMessagesInner } from 'clicksend';

const instance: CalculateSmsPriceRequestMessagesInner = {
    body,
    to,
    from,
    source,
