...
**data** | [**Array&lt;ViewAllowedEmailsDataAllOfDataInner&gt;**](ViewAllowedEmailsDataAllOfDataInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewAllowedEmailsData } from 'clicksend';

const instance: ViewAllowedEmailsData = {
    total,
    per_page,
    current_page,
    last_page,
