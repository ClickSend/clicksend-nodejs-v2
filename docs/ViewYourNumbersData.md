...
**data** | [**Array&lt;ViewYourNumbersDataAllOfDataInner&gt;**](ViewYourNumbersDataAllOfDataInner.md) |  | [optional] [default to undefined]
**_currency** | [**Currency**](Currency.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewYourNumbersData } from 'clicksend';

const instance: ViewYourNumbersData = {
    total,
    per_page,
    current_page,
    last_page,
