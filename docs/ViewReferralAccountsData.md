...
**data** | [**Array&lt;ViewReferralAccountsDataAllOfDataInner&gt;**](ViewReferralAccountsDataAllOfDataInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewReferralAccountsData } from 'clicksend';

const instance: ViewReferralAccountsData = {
    total,
    per_page,
    current_page,
    last_page,
