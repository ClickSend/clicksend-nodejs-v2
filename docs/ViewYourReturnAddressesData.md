...
**data** | [**Array&lt;PostReturnAddress&gt;**](PostReturnAddress.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewYourReturnAddressesData } from 'clicksend';

const instance: ViewYourReturnAddressesData = {
    total,
    per_page,
    current_page,
    last_page,
