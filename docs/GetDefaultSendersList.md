...
**data** | [**GetDefaultSendersListData**](GetDefaultSendersListData.md) |  | [default to undefined]

## Example

```typescript
import { GetDefaultSendersList } from 'clicksend';

const instance: GetDefaultSendersList = {
    http_code,
    response_code,
    response_msg,
    data,
