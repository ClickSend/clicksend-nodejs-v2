...
**data** | [**Array&lt;InboundSms&gt;**](InboundSms.md) | The parameters related to the actual inbound SMS. | [optional] [default to undefined]

## Example

```typescript
import { ViewInboundSmsData } from 'clicksend';

const instance: ViewInboundSmsData = {
    total,
    per_page,
    current_page,
    last_page,
