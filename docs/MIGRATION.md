...
- [Migration Guide: clicksend-nodejs (legacy) → clicksend-nodejs-v2](#migration-guide-clicksend-nodejs-legacy--clicksend-nodejs-v2)
  ...
  - [11. Side-by-side examples for common operations](#11-side-by-side-examples-for-common-operations)
    ...
    - [View SMS history](#view-sms-history)
    - [Send an MMS / Email / Voice message](#send-an-mms--email--voice-message)
    - [Create a contact in a list](#create-a-contact-in-a-list)
    - [List contacts / lists — pagination parameters were dropped](#list-contacts--lists--pagination-parameters-were-dropped)
  ...
  - [13. Endpoints/methods removed in v2](#13-endpointsmethods-removed-in-v2)
    - [Entire products dropped](#entire-products-dropped)
    - [Individual methods dropped (class otherwise survived)](#individual-methods-dropped-class-otherwise-survived)
