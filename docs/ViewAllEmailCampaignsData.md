...
**data** | [**Array&lt;EmailCampaign&gt;**](EmailCampaign.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewAllEmailCampaignsData } from 'clicksend';

const instance: ViewAllEmailCampaignsData = {
    total,
    per_page,
    current_page,
    last_page,
