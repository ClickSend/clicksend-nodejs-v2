...
**data** | [**InboundSms**](InboundSms.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ViewASpecificInboundSmsMessage } from 'clicksend';

const instance: ViewASpecificInboundSmsMessage = {
    http_code,
    response_code,
    response_msg,
    data,
