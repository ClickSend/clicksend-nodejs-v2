...
export class ListOwnNumbers {
    /**
    * The list of own numbers.
    */
    'ownNumbers'?: Array<OwnNumber>;
    'metadata'?: ListOwnNumbersMetadata;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "ownNumbers",
            "baseName": "own_numbers",
            "type": "Array<OwnNumber>"
        },
        {
            "name": "metadata",
            "baseName": "_metadata",
            "type": "ListOwnNumbersMetadata"
        }    ];

    static getAttributeTypeMap() {
        return ListOwnNumbers.attributeTypeMap;
    }
}
