...
export class ViewEmailCampaignHistory {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewEmailCampaignHistoryData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewEmailCampaignHistoryData"
        }    ];

    static getAttributeTypeMap() {
        return ViewEmailCampaignHistory.attributeTypeMap;
    }
}
