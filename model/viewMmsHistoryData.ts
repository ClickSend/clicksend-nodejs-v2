...
export class ViewMmsHistoryData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<ViewMmsHistoryDataAllOfDataInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ViewMmsHistoryDataAllOfDataInner>"
        }    ];

    static getAttributeTypeMap() {
        return ViewMmsHistoryData.attributeTypeMap;
    }
}
