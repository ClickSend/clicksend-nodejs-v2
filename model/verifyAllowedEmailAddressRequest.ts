...
export class VerifyAllowedEmailAddressRequest {
    'to'?: Array<SendEmailRequestToInner>;
    'from'?: SendEmailVerificationTokenRequestFrom;
    'subject'?: string;
    'body'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "from",
            "baseName": "from",
            "type": "SendEmailVerificationTokenRequestFrom"
        },
        {
            "name": "subject",
            "baseName": "subject",
    ...
    static getAttributeTypeMap() {
        return VerifyAllowedEmailAddressRequest.attributeTypeMap;
    }
}
