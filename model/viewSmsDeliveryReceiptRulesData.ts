...
export class ViewSmsDeliveryReceiptRulesData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<SmsDeliveryReceiptRule>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<SmsDeliveryReceiptRule>"
        }    ];

    static getAttributeTypeMap() {
        return ViewSmsDeliveryReceiptRulesData.attributeTypeMap;
    }
}
