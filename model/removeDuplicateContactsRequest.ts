...
export class RemoveDuplicateContactsRequest {
    'fields'?: RemoveDuplicateContactsRequestFields;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "fields",
            "baseName": "fields",
            "type": "RemoveDuplicateContactsRequestFields"
        }    ];

    static getAttributeTypeMap() {
        return RemoveDuplicateContactsRequest.attributeTypeMap;
    }
}
