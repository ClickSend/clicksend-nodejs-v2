...
export class ViewFaxDeliveryReceiptRules {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewFaxDeliveryReceiptRulesData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewFaxDeliveryReceiptRulesData"
        }    ];

    static getAttributeTypeMap() {
        return ViewFaxDeliveryReceiptRules.attributeTypeMap;
    }
}
