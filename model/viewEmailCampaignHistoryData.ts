...
export class ViewEmailCampaignHistoryData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<EmailCampaignHistory>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<EmailCampaignHistory>"
        }    ];

    static getAttributeTypeMap() {
        return ViewEmailCampaignHistoryData.attributeTypeMap;
    }
}
