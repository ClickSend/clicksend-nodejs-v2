...
export class RequestAlphaTagRequest {
    'alphaTag'?: string;
    'reason'?: string;
    'countries'?: Set<RequestAlphaTagRequest.CountriesEnum>;
    'businesses'?: Array<RequestAlphaTagRequestBusinessesInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "countries",
            "baseName": "countries",
            "type": "Set<RequestAlphaTagRequest.CountriesEnum>"
        },
        {
            "name": "businesses",
            "baseName": "businesses",
            "type": "Array<RequestAlphaTagRequestBusinessesInner>"
        }    ];

    static getAttributeTypeMap() {
        return RequestAlphaTagRequest.attributeTypeMap;
    }
}

export namespace RequestAlphaTagRequest {
