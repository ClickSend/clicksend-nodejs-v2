...
export class ViewSpecificTransaction {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewAllTransactionsDataAllOfDataInner;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewAllTransactionsDataAllOfDataInner"
        }    ];

    static getAttributeTypeMap() {
        return ViewSpecificTransaction.attributeTypeMap;
    }
}
