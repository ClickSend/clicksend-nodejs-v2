...
export class ViewTemplateCategories {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: Array<ViewTemplateCategoriesDataInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ViewTemplateCategoriesDataInner>"
        }    ];

    static getAttributeTypeMap() {
        return ViewTemplateCategories.attributeTypeMap;
    }
}
