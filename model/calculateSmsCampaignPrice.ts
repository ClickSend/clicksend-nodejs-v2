...
export class CalculateSmsCampaignPrice {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: CalculateSmsCampaignPriceData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "CalculateSmsCampaignPriceData"
        }    ];

    static getAttributeTypeMap() {
        return CalculateSmsCampaignPrice.attributeTypeMap;
    }
}
