...
export class SendEmailVerificationTokenRequest {
    'to'?: Array<SendEmailVerificationTokenRequestToInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "to",
            "baseName": "to",
            "type": "Array<SendEmailVerificationTokenRequestToInner>"
        },
        {
            "name": "from",
            "baseName": "from",
    ...
    static getAttributeTypeMap() {
        return SendEmailVerificationTokenRequest.attributeTypeMap;
    }
}
