...
export class ViewSmsInboundAutomations {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewSmsInboundAutomationsData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewSmsInboundAutomationsData"
        }    ];

    static getAttributeTypeMap() {
        return ViewSmsInboundAutomations.attributeTypeMap;
    }
}
