...
export class ListCompliantSenderTypes200Response {
    /**
    ...
    */
    'responseMsg': string;
    'data': ListCompliantSenderTypes200ResponseData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ListCompliantSenderTypes200ResponseData"
        }    ];

    static getAttributeTypeMap() {
        return ListCompliantSenderTypes200Response.attributeTypeMap;
    }
}
