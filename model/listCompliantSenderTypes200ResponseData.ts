...
export class ListCompliantSenderTypes200ResponseData {
    'data': Array<ListCompliantSenderTypes200ResponseDataDataInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ListCompliantSenderTypes200ResponseDataDataInner>"
        }    ];

    static getAttributeTypeMap() {
        return ListCompliantSenderTypes200ResponseData.attributeTypeMap;
    }
}
