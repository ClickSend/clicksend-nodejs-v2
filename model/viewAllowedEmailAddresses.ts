...
export class ViewAllowedEmailAddresses {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewAllowedEmailAddressesData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewAllowedEmailAddressesData"
        }    ];

    static getAttributeTypeMap() {
        return ViewAllowedEmailAddresses.attributeTypeMap;
    }
}
