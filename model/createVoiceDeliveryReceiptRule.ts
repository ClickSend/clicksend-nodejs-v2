...
export class CreateVoiceDeliveryReceiptRule {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "VoiceDeliveryReceiptRule"
        }    ];

    static getAttributeTypeMap() {
        return CreateVoiceDeliveryReceiptRule.attributeTypeMap;
    }
}
