...
export class ViewEmailTemplatesData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<ViewEmailTemplatesDataDataInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ViewEmailTemplatesDataDataInner>"
        }    ];

    static getAttributeTypeMap() {
        return ViewEmailTemplatesData.attributeTypeMap;
    }
}
