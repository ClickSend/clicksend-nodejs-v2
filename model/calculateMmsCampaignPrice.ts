...
export class CalculateMmsCampaignPrice {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: CalculateMmsCampaignPriceData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "CalculateMmsCampaignPriceData"
        }    ];

    static getAttributeTypeMap() {
        return CalculateMmsCampaignPrice.attributeTypeMap;
    }
}
