...
export class ListCompliantSenderTypes200ResponseDataDataInner {
    /**
    ...
    */
    'blockedSenderTypes': Array<string>;
    'allowedSenderTypes': Array<ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "blockedSenderTypes",
            "baseName": "blocked_sender_types",
            "type": "Array<string>"
        },
        {
            "name": "allowedSenderTypes",
            "baseName": "allowed_sender_types",
            "type": "Array<ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner>"
        }    ];

    static getAttributeTypeMap() {
        return ListCompliantSenderTypes200ResponseDataDataInner.attributeTypeMap;
    }
}
