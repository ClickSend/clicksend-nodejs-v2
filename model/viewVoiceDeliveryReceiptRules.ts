...
export class ViewVoiceDeliveryReceiptRules {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewVoiceDeliveryReceiptRulesData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewVoiceDeliveryReceiptRulesData"
        }    ];

    static getAttributeTypeMap() {
        return ViewVoiceDeliveryReceiptRules.attributeTypeMap;
    }
}
