...
export class CalculateEmailCampaignPrice {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: CalculateEmailCampaignPriceData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "CalculateEmailCampaignPriceData"
        }    ];

    static getAttributeTypeMap() {
        return CalculateEmailCampaignPrice.attributeTypeMap;
    }
}
