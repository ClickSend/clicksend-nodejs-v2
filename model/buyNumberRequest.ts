...
export class BuyNumberRequest {
    ...
    */
    'type': BuyNumberRequest.TypeEnum;
    'registrationData'?: BuyNumberRequestRegistrationData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "registration_data",
            "type": "BuyNumberRequestRegistrationData"
        }    ];

    static getAttributeTypeMap() {
        return BuyNumberRequest.attributeTypeMap;
    }
}

export namespace BuyNumberRequest {
