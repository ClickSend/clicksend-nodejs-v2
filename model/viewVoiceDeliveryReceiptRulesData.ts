...
export class ViewVoiceDeliveryReceiptRulesData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<VoiceDeliveryReceiptRule>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<VoiceDeliveryReceiptRule>"
        }    ];

    static getAttributeTypeMap() {
        return ViewVoiceDeliveryReceiptRulesData.attributeTypeMap;
    }
}
