...
export class ViewFaxDeliveryReceiptRulesData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<FaxDeliveryReceiptRule>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<FaxDeliveryReceiptRule>"
        }    ];

    static getAttributeTypeMap() {
        return ViewFaxDeliveryReceiptRulesData.attributeTypeMap;
    }
}
