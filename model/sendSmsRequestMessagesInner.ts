...
export class SendSmsRequestMessagesInner {
    /**
    ...
    */
    'excludeNoSenderIdRecipients'?: boolean;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "excludeNoSenderIdRecipients",
            "baseName": "exclude_no_sender_id_recipients",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return SendSmsRequestMessagesInner.attributeTypeMap;
    }
}
