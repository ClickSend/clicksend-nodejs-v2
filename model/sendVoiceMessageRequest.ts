...
export class SendVoiceMessageRequest {
    'messages'?: Array<SendVoiceMessageRequestMessagesInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "messages",
            "baseName": "messages",
            "type": "Array<SendVoiceMessageRequestMessagesInner>"
        }    ];

    static getAttributeTypeMap() {
        return SendVoiceMessageRequest.attributeTypeMap;
    }
}
