...
export class CalculateVoicePriceRequest {
    'messages'?: Array<CalculateVoicePriceRequestMessagesInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "messages",
            "baseName": "messages",
            "type": "Array<CalculateVoicePriceRequestMessagesInner>"
        }    ];

    static getAttributeTypeMap() {
        return CalculateVoicePriceRequest.attributeTypeMap;
    }
}
