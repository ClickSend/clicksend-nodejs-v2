...
export class ViewReferralAccountsData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<ViewReferralAccountsDataAllOfDataInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ViewReferralAccountsDataAllOfDataInner>"
        }    ];

    static getAttributeTypeMap() {
        return ViewReferralAccountsData.attributeTypeMap;
    }
}
