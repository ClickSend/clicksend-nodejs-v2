...
export class CreateSubaccountRequest {
    'apiUsername'?: string;
    'password'?: string;
    'email'?: string;
    'phoneNumber'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "smsDeidentifyMessage",
            "baseName": "sms_deidentify_message",
            "type": "number"
        },
        {
            "name": "accessSmpp",
    ...
    static getAttributeTypeMap() {
        return CreateSubaccountRequest.attributeTypeMap;
    }
}
