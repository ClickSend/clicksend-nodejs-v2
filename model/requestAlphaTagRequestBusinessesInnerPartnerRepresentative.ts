...
*/
export class RequestAlphaTagRequestBusinessesInnerPartnerRepresentative {
    'firstName': string;
    'lastName': string;
    'email': string;
    'title': string;
    ...
    static getAttributeTypeMap() {
        return RequestAlphaTagRequestBusinessesInnerPartnerRepresentative.attributeTypeMap;
    }
}
