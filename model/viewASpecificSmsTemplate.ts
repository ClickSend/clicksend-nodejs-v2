...
export class ViewASpecificSmsTemplate {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewASpecificSmsTemplateData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewASpecificSmsTemplateData"
        }    ];

    static getAttributeTypeMap() {
        return ViewASpecificSmsTemplate.attributeTypeMap;
    }
}
