...
export class ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner {
    /**
    * Type of sender
    */
    'senderType': ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner.SenderTypeEnum;
    'allowedSenderCountries': ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInnerAllowedSenderCountries;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner.SenderTypeEnum"
        },
        {
            "name": "allowedSenderCountries",
            "baseName": "allowed_sender_countries",
            "type": "ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInnerAllowedSenderCountries"
        }    ];

    static getAttributeTypeMap() {
        return ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner.attributeTypeMap;
    }
}

export namespace ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner {
