...
export class CalculateSmsPriceDataSummaryCountriesInner {
    'country'?: CalculateSmsPriceDataSummaryCountriesInnerCountry;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "country",
            "baseName": "country",
            "type": "CalculateSmsPriceDataSummaryCountriesInnerCountry"
        }    ];

    static getAttributeTypeMap() {
        return CalculateSmsPriceDataSummaryCountriesInner.attributeTypeMap;
    }
}
