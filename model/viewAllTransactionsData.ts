...
export class ViewAllTransactionsData {
    /**
    ...
    */
    'to'?: number;
    'data'?: Array<ViewAllTransactionsDataAllOfDataInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ViewAllTransactionsDataAllOfDataInner>"
        }    ];

    static getAttributeTypeMap() {
        return ViewAllTransactionsData.attributeTypeMap;
    }
}
