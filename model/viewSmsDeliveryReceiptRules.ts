...
export class ViewSmsDeliveryReceiptRules {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewSmsDeliveryReceiptRulesData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewSmsDeliveryReceiptRulesData"
        }    ];

    static getAttributeTypeMap() {
        return ViewSmsDeliveryReceiptRules.attributeTypeMap;
    }
}
