...
* The metadata.
*/
export class ListOwnNumbersMetadata {
    'pagination'?: ListOwnNumbersMetadataPagination;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "pagination",
            "baseName": "pagination",
            "type": "ListOwnNumbersMetadataPagination"
        }    ];

    static getAttributeTypeMap() {
        return ListOwnNumbersMetadata.attributeTypeMap;
    }
}
