...
export class CalculateMmsPriceRequest {
    'mediaFile'?: string;
    'messages'?: Array<CalculateMmsPriceRequestMessagesInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "messages",
            "baseName": "messages",
            "type": "Array<CalculateMmsPriceRequestMessagesInner>"
        }    ];

    static getAttributeTypeMap() {
        return CalculateMmsPriceRequest.attributeTypeMap;
    }
}
