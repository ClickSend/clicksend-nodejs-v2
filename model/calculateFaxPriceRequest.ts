...
export class CalculateFaxPriceRequest {
    'fileUrl'?: string;
    'messages'?: Array<CalculateFaxPriceRequestMessagesInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "messages",
            "baseName": "messages",
            "type": "Array<CalculateFaxPriceRequestMessagesInner>"
        }    ];

    static getAttributeTypeMap() {
        return CalculateFaxPriceRequest.attributeTypeMap;
    }
}
