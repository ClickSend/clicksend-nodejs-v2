...
export class ViewVoiceStatisticsData {
    'total'?: ViewVoiceStatisticsDataTotal;
    'stats'?: Array<ViewVoiceStatisticsDataStatsInner>;
    'currency'?: Currency;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "total",
            "baseName": "total",
            "type": "ViewVoiceStatisticsDataTotal"
        },
        {
            "name": "stats",
            "baseName": "stats",
            "type": "Array<ViewVoiceStatisticsDataStatsInner>"
        },
        {
            "name": "currency",
            "baseName": "_currency",
    ...
    static getAttributeTypeMap() {
        return ViewVoiceStatisticsData.attributeTypeMap;
    }
}
