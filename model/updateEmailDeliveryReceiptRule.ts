...
export class UpdateEmailDeliveryReceiptRule {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "EmailDeliveryReceiptRule"
        }    ];

    static getAttributeTypeMap() {
        return UpdateEmailDeliveryReceiptRule.attributeTypeMap;
    }
}
