...
export class ViewEmailDeliveryReceiptRules {
    /**
    ...
    */
    'responseMsg'?: string;
    'data'?: ViewEmailDeliveryReceiptRulesData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "ViewEmailDeliveryReceiptRulesData"
        }    ];

    static getAttributeTypeMap() {
        return ViewEmailDeliveryReceiptRules.attributeTypeMap;
    }
}
