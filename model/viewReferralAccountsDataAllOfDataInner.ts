...
export class ViewReferralAccountsDataAllOfDataInner {
    /**
    * The ID of the Referral Account.
    */
    'referralRuleId'?: number;
    /**
    * The ID of the Referral Account.
    */
    'referedUserId'?: number;
    /**
    * The ID of the Referral Account.
    */
    'dateReferred'?: number;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "referralRuleId",
            "baseName": "referral_rule_id",
            "type": "number"
        },
        {
            "name": "referedUserId",
            "baseName": "refered_user_id",
            "type": "number"
        },
        {
            "name": "dateReferred",
            "baseName": "date_referred",
            "type": "number"
        },
        {
            "name": "percentageReferral",
            "baseName": "percentage_referral",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return ViewReferralAccountsDataAllOfDataInner.attributeTypeMap;
    }
}
