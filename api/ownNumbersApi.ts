...
export enum OwnNumbersApiApiKeys {
}

export class OwnNumbersApi {
    ...
    public setApiKey(key: OwnNumbersApiApiKeys, value: string) {
        (this.authentications as any)[OwnNumbersApiApiKeys[key]].apiKey = value;
    }
