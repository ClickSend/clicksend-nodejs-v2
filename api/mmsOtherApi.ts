...
export enum MmsOtherApiApiKeys {
}

export class MmsOtherApi {
    ...
    public setApiKey(key: MmsOtherApiApiKeys, value: string) {
        (this.authentications as any)[MmsOtherApiApiKeys[key]].apiKey = value;
    }
