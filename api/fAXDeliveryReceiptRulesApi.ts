...
export class FAXDeliveryReceiptRulesApi {
     ...
     */
    public async faxDeliveryReceiptAutomationDelete (receiptRuleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     * @param receiptRuleId Receipt rule id
     */
    public async faxDeliveryReceiptAutomationGet (receiptRuleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/fax/receipts/{receipt_rule_id}'
            .replace('{receipt_rule_id}', encodeURIComponent(String(receiptRuleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async faxDeliveryReceiptAutomationPost (deliveryReceiptRule: DeliveryReceiptRule, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     */
    public async faxDeliveryReceiptAutomationPut (receiptRuleId: number, deliveryReceiptRule: DeliveryReceiptRule, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/fax/receipts/{receipt_rule_id}'
            .replace('{receipt_rule_id}', encodeURIComponent(String(receiptRuleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async faxDeliveryReceiptAutomationsGet (q?: string, page?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/fax/receipts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
