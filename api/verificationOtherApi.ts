...
export enum VerificationOtherApiApiKeys {
}

export class VerificationOtherApi {
    ...
    public setApiKey(key: VerificationOtherApiApiKeys, value: string) {
        (this.authentications as any)[VerificationOtherApiApiKeys[key]].apiKey = value;
    }
