...
export enum NumbersOtherApiApiKeys {
}

export class NumbersOtherApi {
    ...
    public setApiKey(key: NumbersOtherApiApiKeys, value: string) {
        (this.authentications as any)[NumbersOtherApiApiKeys[key]].apiKey = value;
    }
