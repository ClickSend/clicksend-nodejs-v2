...
export enum LettersOtherApiApiKeys {
}

export class LettersOtherApi {
    ...
    public setApiKey(key: LettersOtherApiApiKeys, value: string) {
        (this.authentications as any)[LettersOtherApiApiKeys[key]].apiKey = value;
    }
