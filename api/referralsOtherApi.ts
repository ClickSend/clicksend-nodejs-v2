...
export enum ReferralsOtherApiApiKeys {
}

export class ReferralsOtherApi {
    ...
    public setApiKey(key: ReferralsOtherApiApiKeys, value: string) {
        (this.authentications as any)[ReferralsOtherApiApiKeys[key]].apiKey = value;
    }
