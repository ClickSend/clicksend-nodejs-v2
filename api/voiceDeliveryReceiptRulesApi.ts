...
export class VoiceDeliveryReceiptRulesApi {
     ...
     */
    public async voiceDeliveryReceiptAutomationDelete (receiptRuleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     * @param receiptRuleId Receipt rule id
     */
    public async voiceDeliveryReceiptAutomationGet (receiptRuleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/voice/receipts/{receipt_rule_id}'
            .replace('{receipt_rule_id}', encodeURIComponent(String(receiptRuleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async voiceDeliveryReceiptAutomationPost (deliveryReceiptRule: DeliveryReceiptRule, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     */
    public async voiceDeliveryReceiptAutomationPut (receiptRuleId: number, deliveryReceiptRule: DeliveryReceiptRule, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/voice/receipts/{receipt_rule_id}'
            .replace('{receipt_rule_id}', encodeURIComponent(String(receiptRuleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async voiceDeliveryReceiptAutomationsGet (q?: string, page?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/voice/receipts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
