...
export enum StatisticsOtherApiApiKeys {
}

export class StatisticsOtherApi {
    ...
    public setApiKey(key: StatisticsOtherApiApiKeys, value: string) {
        (this.authentications as any)[StatisticsOtherApiApiKeys[key]].apiKey = value;
    }
