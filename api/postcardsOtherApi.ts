...
export enum PostcardsOtherApiApiKeys {
}

export class PostcardsOtherApi {
    ...
    public setApiKey(key: PostcardsOtherApiApiKeys, value: string) {
        (this.authentications as any)[PostcardsOtherApiApiKeys[key]].apiKey = value;
    }
