...
export enum VoiceMessagingOtherApiApiKeys {
}

export class VoiceMessagingOtherApi {
    ...
    public setApiKey(key: VoiceMessagingOtherApiApiKeys, value: string) {
        (this.authentications as any)[VoiceMessagingOtherApiApiKeys[key]].apiKey = value;
    }
