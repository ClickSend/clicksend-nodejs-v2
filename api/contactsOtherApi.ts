...
export enum ContactsOtherApiApiKeys {
}

export class ContactsOtherApi {
    ...
    public setApiKey(key: ContactsOtherApiApiKeys, value: string) {
        (this.authentications as any)[ContactsOtherApiApiKeys[key]].apiKey = value;
    }
