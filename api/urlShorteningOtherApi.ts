...
export enum UrlShorteningOtherApiApiKeys {
}

export class UrlShorteningOtherApi {
    ...
    public setApiKey(key: UrlShorteningOtherApiApiKeys, value: string) {
        (this.authentications as any)[UrlShorteningOtherApiApiKeys[key]].apiKey = value;
    }
