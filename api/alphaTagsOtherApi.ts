...
export enum AlphaTagsOtherApiApiKeys {
}

export class AlphaTagsOtherApi {
    ...
    public setApiKey(key: AlphaTagsOtherApiApiKeys, value: string) {
        (this.authentications as any)[AlphaTagsOtherApiApiKeys[key]].apiKey = value;
    }
