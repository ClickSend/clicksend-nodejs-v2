...
import { ResellerAccountTransferCredit } from '../model/resellerAccountTransferCredit';
...
export class TransferCreditApi {
     ...
     */
    public async resellerTransferCreditPut (resellerAccountTransferCredit: ResellerAccountTransferCredit, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
