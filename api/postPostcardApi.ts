...
import { PostPostcard } from '../model/postPostcard';
...
export class PostPostcardApi {
     ...
     */
    public async postPostcardsHistoryExportGet (filename: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     */
    public async postPostcardsHistoryGet (page?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     */
    public async postPostcardsPricePost (postPostcards: PostPostcard, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     * @param postPostcards PostPostcard model
     */
    public async postPostcardsSendPost (postPostcards: PostPostcard, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
