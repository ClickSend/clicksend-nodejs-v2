...
export enum UploadsOtherApiApiKeys {
}

export class UploadsOtherApi {
    ...
    public setApiKey(key: UploadsOtherApiApiKeys, value: string) {
        (this.authentications as any)[UploadsOtherApiApiKeys[key]].apiKey = value;
    }
