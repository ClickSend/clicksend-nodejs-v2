...
export class SMSDeliveryReceiptRulesApi {
     ...
     */
    public async smsDeliveryReceiptAutomationDelete (receiptRuleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     * @param receiptRuleId Receipt rule id
     */
    public async smsDeliveryReceiptAutomationGet (receiptRuleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/sms/receipts/{receipt_rule_id}'
            .replace('{receipt_rule_id}', encodeURIComponent(String(receiptRuleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async smsDeliveryReceiptAutomationPost (deliveryReceiptRule: DeliveryReceiptRule, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     */
    public async smsDeliveryReceiptAutomationPut (receiptRuleId: number, deliveryReceiptRule: DeliveryReceiptRule, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/sms/receipts/{receipt_rule_id}'
            .replace('{receipt_rule_id}', encodeURIComponent(String(receiptRuleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async smsDeliveryReceiptAutomationsGet (q?: string, page?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/automations/sms/receipts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
