...
export enum MessageDeliveryOtherApiApiKeys {
}

export class MessageDeliveryOtherApi {
    ...
    public setApiKey(key: MessageDeliveryOtherApiApiKeys, value: string) {
        (this.authentications as any)[MessageDeliveryOtherApiApiKeys[key]].apiKey = value;
    }
