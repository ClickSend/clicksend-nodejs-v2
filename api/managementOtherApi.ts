...
export enum ManagementOtherApiApiKeys {
}

export class ManagementOtherApi {
    ...
    public setApiKey(key: ManagementOtherApiApiKeys, value: string) {
        (this.authentications as any)[ManagementOtherApiApiKeys[key]].apiKey = value;
    }
